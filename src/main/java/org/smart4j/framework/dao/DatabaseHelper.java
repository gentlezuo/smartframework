...
public class DatabaseHelper {
     ...
     * @return
     */
    public static <T> T queryEntity(Class<?> entiryClass,String sql,Object... params){
        return (T) dataAccessor.queryEntity(entiryClass,sql,params);
    }
